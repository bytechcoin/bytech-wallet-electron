...
const WALLETTECH_VERSION = app.getVersion() || '0.3.6';
...
log.info(`Starting WalletTech ${WALLETTECH_VERSION}`);
...
function createWindow () {
    ...
    const winOpts = {
        ...
        icon: path.join(__dirname,'src/assets/wallettech_icon.png'),
        frame: true,
...
function initSettings(){
    ...
    settings.set('version', WALLETTECH_VERSION);
    serviceBinCheck();
}
