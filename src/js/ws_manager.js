...
const WalletTechSession = require('./ws_session');
const WalletTechApi = require('./ws_api');
const uiupdater = require('./wsui_updater');
const wsutil = require('./ws_utils');
const config = require('./ws_config');

const settings = new Store({name: 'Settings'});
const wsession = new WalletTechSession();
...
var WalletTechManager = function(){
    if (!(this instanceof WalletTechManager)){
        return new WalletTechManager();
    }
...
WalletTechManager.prototype.init = function(){
    this._getSettings();
    ...
    this.serviceApi = new WalletTechApi(cfg);
};

WalletTechManager.prototype._getSettings = function(){
    this.daemonHost = settings.get('daemon_host');
    this.daemonPort = settings.get('daemon_port');
    this.serviceBin = settings.get('service_bin');
};

WalletTechManager.prototype._reinitSession = function(){
    wsession.reset();
...
// check 
WalletTechManager.prototype.serviceStatus = function(){
    return  (undefined !== this.serviceProcess && null !== this.serviceProcess);
};

WalletTechManager.prototype.isRunning = function () {
    this.init();
...
WalletTechManager.prototype._writeIniConfig = function(cfg){
    let configFile = wsession.get('walletConfig');
...
WalletTechManager.prototype._writeConfig = function(cfg){
    let configFile = wsession.get('walletConfig');
    if(!configFile) return '';
...
WalletTechManager.prototype.startService = function(walletFile, password, onError, onSuccess, onDelay){
    this.init();
...
WalletTechManager.prototype._argsToIni = function(args) {
    let configData = "";
...
WalletTechManager.prototype._spawnService = function(walletFile, password, onError, onSuccess, onDelay){
    this.init();
...
WalletTechManager.prototype.stopService = function(){
    this.init();
    let wsm = this;
...
WalletTechManager.prototype.terminateService = function(force) {
...
WalletTechManager.prototype.startSyncWorker = function(){
    this.init();
    let wsm = this;
...
WalletTechManager.prototype.stopSyncWorker = function(){
...
WalletTechManager.prototype.getNodeFee = function(){
    let wsm = this;
...
WalletTechManager.prototype.genIntegratedAddress = function(paymentId, address){
    let wsm = this;
...
WalletTechManager.prototype.createWallet = function(walletFile, password){
    this.init();
    let wsm = this;
    return new Promise((resolve, reject) => {
...
WalletTechManager.prototype.importFromKeys = function(walletFile, password, viewKey, spendKey, scanHeight){
    this.init();
    let wsm = this;
    return new Promise((resolve, reject) => {
...
WalletTechManager.prototype.importFromSeed = function(walletFile, password, mnemonicSeed, scanHeight){
    this.init();
    let wsm = this;
    return new Promise((resolve, reject) => {
        scanHeight = scanHeight || 0;
...
WalletTechManager.prototype.getSecretKeys = function(address){
    let wsm = this;
    return new Promise((resolve, reject) => {
...
WalletTechManager.prototype.sendTransaction = function(params){
    let wsm = this;
    return new Promise((resolve, reject) => {
...
WalletTechManager.prototype._fusionGetMinThreshold = function(threshold, minThreshold, maxFusionReadyCount, counter){
    let wsm = this;
    return new Promise((resolve, reject) => {
        counter = counter || 0;
...
WalletTechManager.prototype._fusionSendTx = function(threshold, counter){
    let wsm = this;
    return new Promise((resolve, reject) => {
        counter = counter || 0;
        let maxIter = 256;
...
WalletTechManager.prototype.optimizeWallet = function(){
    let wsm = this;
    return new Promise( (resolve, reject) => {
        wsm.fusionTxHash = [];
...
WalletTechManager.prototype.networkStateUpdate = function(state){
    ...
    if(state === 0){
        ...
        this.init();
        // looks like bytech-service always stalled after disconnected, just kill & relaunch it
...
WalletTechManager.prototype.notifyUpdate = function(msg){
    uiupdater.updateUiState(msg);
};

WalletTechManager.prototype.resetState = function(){
    return this._reinitSession();
};

module.exports = WalletTechManager;
