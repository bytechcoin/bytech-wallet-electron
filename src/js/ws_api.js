...
class WalletTechApi {
    constructor(args) {
        args = args || {};
        if (!(this instanceof WalletTechApi)) return new WalletTechApi(args);
    ...
    sendTransaction(params) {
        return new Promise((resolve, reject) => {
            ...
            if (parseFloat(params.fee) < 0.1) return reject(new Error('Minimum fee is 0.1 BYTC'));
            //[{address: "bYTCxxxx...", amount: 100}];
            var req_params = {
